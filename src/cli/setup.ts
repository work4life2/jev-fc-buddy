...
• ${cfg.coins.perDollar} coin per ${cfg.service.currency}; 1 coin = one play session of up to ${cfg.coins.sessionMinutes} minutes; buy N ${cfg.service.currency} to get N coins on one code
